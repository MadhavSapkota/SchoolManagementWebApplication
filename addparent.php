<?php
  ...
  if(isset($_POST["Submit"])){
	if(!empty($_POST["FName"])&&!empty($_POST["SID"])){
        ...
        $insertParent = "INSERT INTO parents_record(first_name,middle_name,last_name,student_id,email,password,phone_num,address)
        VALUES('".$FName."','".$MName."','".$LName."','".$SID."','".$Email."','".$Password."','".$PhoneNum."','".$Address."')";

		$connect->exec($insertParent);
